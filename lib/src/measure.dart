...
abstract class VectorMeasure<Q extends Quantity> extends Measure<List<double>, Q> {
    ...
    factory VectorMeasure.twoDimensional(double x, double y, Unit unit) = _TwoDimensional<Q>;

    /// Creates a 3-dimensional measurement vector.
    factory VectorMeasure.threeDimensional(double x, double y, double z, Unit unit) = _ThreeDimensional<Q>;

    /// Creates a multi-dimensional measurement vector.
    factory VectorMeasure.multiDimensional(List<double> components, Unit unit) = _MultiDimensional<Q>;
